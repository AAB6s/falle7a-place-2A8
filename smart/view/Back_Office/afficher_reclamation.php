<?php
require_once __DIR__ . '/../../controller/reclamationC.php';
$reclamationController = new ReclamationC();
$reclamation = $reclamationController->listeReclamations();
?>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel" id="view_anal">
                <div class="content-wrapper">
                    <!-- Reclamation View Section -->
                    <div class="row" id="reclamation_view">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Reclamations</h4>
                                    <p class="card-description">View all submitted reclamations.</p>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="text-center">No reclamations available.</td>
                                                </tr>
                                                <?php else : ?>
                                                <?php foreach ($reclamation as $rec) : ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($rec['id_rec']); ?></td>
