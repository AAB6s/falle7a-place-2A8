...
<head>
    ...
    .table-striped tbody tr:nth-child(odd) {
        ...
        /* Darker rows for alternating */
    }

    .table-striped tbody tr:nth-child(even) {
        background-color: #232540;
        /* Slightly different color for even rows */
    }

    .btn-delete {
        background-color: #ff5e57;
        /* Soft red for delete button */
        color: #ffffff;
        font-size: 0.875rem;
        padding: 6px 12px;
        border-radius: 5px;
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-dark table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo htmlspecialchars($reservation->getIdReservation()); ?>
                                                </td>
                                                <td><?php echo htmlspecialchars($reservation->getIdEmploye()); ?></td>
                                                <td><?php echo htmlspecialchars($reservation->getDebutReservation()); ?>
                                                </td>
                                                <td><?php echo htmlspecialchars($reservation->getFinReservation()); ?>
                                                </td>
                                                <td><?php echo htmlspecialchars($reservation->getDescription()); ?></td>
                                                <td>
                                                    <a href="reservationDetails.php?id_reservation=<?php echo $reservation->getIdReservation(); ?>"
                                                    ...
                                                    <form method="POST" action="" class="d-inline"
                                                        ...
                                                        <button type="submit" class="btn btn-delete btn-sm">Delete
                                                            Reservation</button>
                                                    </form>
                                                </td>
                                            </tr>
