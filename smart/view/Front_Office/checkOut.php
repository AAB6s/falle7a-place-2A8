        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            ...
            <tbody>
                <?php foreach ($orders as $order): ?>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 10px;"><?php echo htmlspecialchars($order['Nom']); ?></td>
                        <td style="border: 1px solid #ddd; padding: 10px; text-align: center;"><?php echo $order['quantity']; ?></td>
                        <td style="border: 1px solid #ddd; padding: 10px; text-align: right;"><?php echo number_format($order['Prix'], 2); ?> TND</td>
                        <?php $totalPrice += $order['Prix'] * $order['quantity']; ?>
                    </tr>
                <?php endforeach; ?>
                <tr>
                    <td></td>
