...
<body><script>if (!localStorage.getItem('token') || JSON.parse(atob(localStorage.getItem('token').split('.')[1])).data.role === 'user') window.location.href = "logout.php";</script>
                                    ...
                                    <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="Description"
                                                name="Description"><?php echo htmlspecialchars($produit['Description']); ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="Quantite" name="Quantite"
                                                value="<?php echo htmlspecialchars($produit['Quantite']); ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="id_Categorie" name="id_Categorie">
                                                ...
                                                <option value="<?php echo $categorie['Id_Categorie']; ?>"
                                                    <?php echo ($categorie['Id_Categorie'] == $produit['Id_Categorie']) ? 'selected' : ''; ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small>Image actuelle :
                                                <img class="img-fluid"
                                                    src="data:image/jpeg;base64,<?php echo base64_encode($produit['Image']); ?>"></small>
                                        </div>
                                ...
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    form.addEventListener("submit", function(event) {
                                        ...
                                        const fields = [{
                                                ...
                                                errorMsg: "Le champ Nom ne peut pas être vide."
                                            },
                                            {
                                                selector: "textarea[name='Description']",
                                                validate: value => value.trim() !== "",
                                                errorMsg: "Le champ Description ne peut pas être vide."
                                            },
                                            {
                                                selector: "input[name='Prix']",
                                                validate: value => parseFloat(value) > 0 && !isNaN(
                                                    value),
                                                errorMsg: "Le champ Prix doit être supérieur à 0."
                                            },
                                            {
                                                selector: "input[name='Quantite']",
                                                validate: value => parseInt(value) > 0 && Number
                                                    .isInteger(parseFloat(value)),
                                                errorMsg: "Le champ Quantité doit être un entier positif."
                                            },
                                            {
                                                selector: "select[name='id_Categorie']",
