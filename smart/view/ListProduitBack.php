                            ...
                            <div class="container mt-5">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th style="font-weight: bold; color: #7B9E7F; font-size: 18px;">Image
                                                </th>
                                                <th style="font-weight: bold; color: #7B9E7F; font-size: 18px;">Nom</th>
                                                <th style="font-weight: bold; color: #7B9E7F; font-size: 18px;">
                                                    Description</th>
                                                <th style="font-weight: bold; color: #7B9E7F; font-size: 18px;">Prix
                                                </th>
                                                <th style="font-weight: bold; color: #7B9E7F; font-size: 18px;">Quantité
                                                </th>
                                                <th style="font-weight: bold; color: #7B9E7F; font-size: 18px;">
                                                    Catégorie</th>
                                                <th style="font-weight: bold; color: #7B9E7F; font-size: 18px;">Actions
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Bouton Modifier -->
                                                    <a href="edit_produit.php?Id_Produit=<?= $produit['id_Produit']; ?>"
