            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="product-management">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="#">Add Categorie</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Ajout Catégorie</h3>
                            ...
                            <div class="card-body">
                                ...
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    function showMessage(input, message, isSuccess) {
                                        // Remove existing message for the same input
                                        const existingMessage = input.closest('.form-group').querySelector(
                                            ".error-message");
