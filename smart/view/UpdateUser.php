...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_id'])) {
    $updatedUser = new User($_POST['name'], $_POST['email'], $_POST['password'], $_POST['address'],$_POST['role']);
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="Back_Office/index.php"><img src="assets/images/logo.svg"
                        alt="logo" /></a>
                <a class="sidebar-brand brand-logo-mini" href="Back_Office/index.php"><img
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="worker-management">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="Back_Office/dashboard.php">
                                    Employees
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="Back_Office/reservationList.php">
                                    Reservations
                                </a>
                            </li>
                        </ul>
                                        ...
                                        <tr id="user-row-<?= $user['id'] ?>">
                                            <form method="POST">
                                                ...
                                                <td>
                                                    ...
                                                    <button type="submit" class="btn-circle btn-edit"
